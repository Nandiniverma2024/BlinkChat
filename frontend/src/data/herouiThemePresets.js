// Theme Array of Objects for HeroUI Theme Builder. Each object has an `id`, `label`, and `swatch` (CSS gradient string) for the preset. IDs match `data-theme-preset` in CSS.
